...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('repo_os') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('repo_definition') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('repo_tags') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('repo_applicable_services') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('user_authentication') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('kerberos_keytab_principal') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('kkp_mapping_service') AND type = 'U')
BEGIN
