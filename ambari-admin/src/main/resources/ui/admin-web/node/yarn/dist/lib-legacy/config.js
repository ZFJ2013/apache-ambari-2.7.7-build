...
class Config {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (const dir of linkedModules) {
        ...
        if (dir[0] === '@') {
          ...
          (_linkedModules = _this.linkedModules).push.apply(_linkedModules, (0, (_toConsumableArray2 || _load_toConsumableArray()).default)(scopedLinked.map(function (scopedDir) {
  ...
  readManifest(dir, priorityRegistry) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      let isRoot = _arguments2.length > 2 && _arguments2[2] !== undefined ? _arguments2[2] : false;
  ...
  */
  ...
  saveRootManifests(manifests) {
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      for (const registryName of (_index2 || _load_index2()).registryNames) {
        ...
        yield (_fs || _load_fs()).writeFilePreservingEol(loc, (0, (_stringify || _load_stringify()).default)(object, null, indent || (_constants || _load_constants()).DEFAULT_INDENT) + '\n');
      }
    })();
  }
  ...
  readJson(loc) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      let factory = _arguments3.length > 1 && _arguments3[1] !== undefined ? _arguments3[1] : (_fs || _load_fs()).readJson;
  ...
  static create() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      let opts = _arguments4.length > 0 && _arguments4[0] !== undefined ? _arguments4[0] : {};
      let reporter = _arguments4.length > 1 && _arguments4[1] !== undefined ? _arguments4[1] : new (_index3 || _load_index3()).NoopReporter();
